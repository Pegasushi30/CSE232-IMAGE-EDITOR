...
void bmp_setpixelcolor(bmp_image *img, int x, int y, bmp_color color, uint8_t value)
{
    switch (img->dib.bmiHeader.biBitCount)
    {
    case BMP_0_BITS:
    ...
    case BMP_4_BITS:
        ...
        break;
    case BMP_8_BITS:
        img->ciPixelArray[y * img->dib.bmiHeader.biWidth + x] = value;
        break;
    case BMP_16_BITS:
        // TODO: add support for this format.
        break;
    case BMP_24_BITS:
        img->ciPixelArray[3 * (y * img->dib.bmiHeader.biWidth + x) + color] = value;
        break;
    case BMP_32_BITS:
        img->ciPixelArray[4 * (y * img->dib.bmiHeader.biWidth + x) + color] = value;
        break;
    default:
        break;
    }
...
bmp_image *bmp_rgb2gray(bmp_image *img, bmp_setncolours ncolours)
{
    ...
    uint32_t palettesize = pow(2, new->dib.bmiHeader.biBitCount) * sizeof(bmp_rgbquad);

    new->fileheader.bfType = BMP_FILETYPE_BM;
    new->fileheader.bfSize = BMP_FILEHEADER_SIZE + new->dib.bmiHeader.biSize + palettesize + new->dib.bmiHeader.biSizeImage;

    new->fileheader.bfReserved1 = 0;
    new->fileheader.bfReserved2 = 0;

    new->fileheader.bfOffBits = BMP_FILEHEADER_SIZE + new->dib.bmiHeader.biSize + palettesize;
...
void bmp_padh(bmp_image *img, uint32_t num, bmp_padtype type)
{
    ...
    uint32_t datasize = newWidth * img->dib.bmiHeader.biHeight * img->dib.bmiHeader.biBitCount / BMP_8_BITS;
...
void bmp_padv(bmp_image *img, uint32_t num, bmp_padtype type)
{
    ...
    uint32_t datasize = img->dib.bmiHeader.biWidth * newHeight * img->dib.bmiHeader.biBitCount / BMP_8_BITS;
...
int bmp_checkheaders(bmp_image *img)
{
    ...
    if (img->dib.bmiHeader.biSize >= BMP_V5HEADER)
    {
        ...
        {
        case BMP_LCS_GM_ABS_COLORIMETRIC:
            break;
        case BMP_LCS_GM_BUSINESS:
            break;
        case BMP_LCS_GM_GRAPHICS:
            break;
        case BMP_LCS_GM_IMAGES:
            break;
        default:
            return 0;
        }
...
bmp_image *bmp_getredbricks()
{
    ...
    img->dib.bmiColors[0].rgbBlue = 0x00;
    img->dib.bmiColors[0].rgbGreen = 0x00;
    img->dib.bmiColors[0].rgbRed = 0x00;
    img->dib.bmiColors[0].rgbReserved = 0x00;
    img->dib.bmiColors[1].rgbBlue = 0x00;
    img->dib.bmiColors[1].rgbGreen = 0x00;
    img->dib.bmiColors[1].rgbRed = 0x80;
    img->dib.bmiColors[1].rgbReserved = 0x00;
    img->dib.bmiColors[2].rgbBlue = 0x00;
    img->dib.bmiColors[2].rgbGreen = 0x80;
    img->dib.bmiColors[2].rgbRed = 0x00;
    img->dib.bmiColors[2].rgbReserved = 0x00;
    img->dib.bmiColors[3].rgbBlue = 0x00;
    img->dib.bmiColors[3].rgbGreen = 0x80;
    img->dib.bmiColors[3].rgbRed = 0x80;
    img->dib.bmiColors[3].rgbReserved = 0x00;

    img->dib.bmiColors[4].rgbBlue = 0x80;
    img->dib.bmiColors[4].rgbGreen = 0x00;
    img->dib.bmiColors[4].rgbRed = 0x00;
    img->dib.bmiColors[4].rgbReserved = 0x00;
    img->dib.bmiColors[5].rgbBlue = 0x80;
    img->dib.bmiColors[5].rgbGreen = 0x00;
    img->dib.bmiColors[5].rgbRed = 0x80;
    img->dib.bmiColors[5].rgbReserved = 0x00;
    img->dib.bmiColors[6].rgbBlue = 0x80;
    img->dib.bmiColors[6].rgbGreen = 0x80;
    img->dib.bmiColors[6].rgbRed = 0x00;
    img->dib.bmiColors[6].rgbReserved = 0x00;
    img->dib.bmiColors[7].rgbBlue = 0x80;
    img->dib.bmiColors[7].rgbGreen = 0x80;
    img->dib.bmiColors[7].rgbRed = 0x80;
    img->dib.bmiColors[7].rgbReserved = 0x00;

    img->dib.bmiColors[8].rgbBlue = 0xc0;
    img->dib.bmiColors[8].rgbGreen = 0xc0;
    img->dib.bmiColors[8].rgbRed = 0xc0;
    img->dib.bmiColors[8].rgbReserved = 0x00;
    img->dib.bmiColors[9].rgbBlue = 0x00;
    img->dib.bmiColors[9].rgbGreen = 0x00;
    img->dib.bmiColors[9].rgbRed = 0xff;
    img->dib.bmiColors[9].rgbReserved = 0x00;
    img->dib.bmiColors[10].rgbBlue = 0x00;
    img->dib.bmiColors[10].rgbGreen = 0xff;
    img->dib.bmiColors[10].rgbRed = 0x00;
    img->dib.bmiColors[10].rgbReserved = 0x00;
    img->dib.bmiColors[11].rgbBlue = 0x00;
    img->dib.bmiColors[11].rgbGreen = 0xff;
    img->dib.bmiColors[11].rgbRed = 0xff;
    img->dib.bmiColors[11].rgbReserved = 0x00;

    img->dib.bmiColors[12].rgbBlue = 0xff;
    img->dib.bmiColors[12].rgbGreen = 0x00;
    img->dib.bmiColors[12].rgbRed = 0x00;
    img->dib.bmiColors[12].rgbReserved = 0x00;
    img->dib.bmiColors[13].rgbBlue = 0xff;
    img->dib.bmiColors[13].rgbGreen = 0x00;
    img->dib.bmiColors[13].rgbRed = 0xff;
    img->dib.bmiColors[13].rgbReserved = 0x00;
    img->dib.bmiColors[14].rgbBlue = 0xff;
    img->dib.bmiColors[14].rgbGreen = 0xff;
    img->dib.bmiColors[14].rgbRed = 0x00;
    img->dib.bmiColors[14].rgbReserved = 0x00;
    img->dib.bmiColors[15].rgbBlue = 0xff;
    img->dib.bmiColors[15].rgbGreen = 0xff;
    img->dib.bmiColors[15].rgbRed = 0xff;
    img->dib.bmiColors[15].rgbReserved = 0x00;
...
bmp_image *bmp_8bpp_sample()
{
     ...
     */
    uint32_t colourpalettesize = pow(2, img->dib.bmiHeader.biBitCount) * sizeof(bmp_rgbquad);

    uint32_t datasize = img->dib.bmiHeader.biWidth * img->dib.bmiHeader.biHeight * img->dib.bmiHeader.biBitCount / BMP_8_BITS;

    img->fileheader.bfType = BMP_FILETYPE_BM;
    img->fileheader.bfSize = BMP_FILEHEADER_SIZE + img->dib.bmiHeader.biSize + colourpalettesize + datasize;

    img->fileheader.bfReserved1 = 0;
    img->fileheader.bfReserved2 = 0;

    img->fileheader.bfOffBits = BMP_FILEHEADER_SIZE + img->dib.bmiHeader.biSize + colourpalettesize;
...
bmp_image *bmp_rle8decoder(bmp_image *img)
{
    if (img == NULL)
        return NULL;
    if (bmp_getcompression(img) != BMP_BI_RLE8)
        return NULL;
    ...
    for (uint32_t pixel = 0; pixel < new->dib.bmiHeader.biSizeImage;)
    {
        ...
        {
            if (duos[index + 1].value == 1)
                break;
            if (duos[index + 1].value == 0)
            {
                if (duos[index].count > 0)
                    duos[index].count -= 1;
            }
        }
